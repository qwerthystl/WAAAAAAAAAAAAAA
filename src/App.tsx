  ...
  return (
    <div className="valentine-container">
      ...
      {!yesPressed ? (
        ...
        <>
          <p>
            I know you have awesome people to hang out with and I understand if
            you already have plans sa 14.. I just wannted to take my shot and
            ask you if I can be your valentine this year.. HA HA HA HA HA HA HA
            HA sobrang jejemon,,, sobrang latina grabe sobrang sarap.. kung no
            talaga yan ah edi block mo na lang talaga ako kasi nakakahiya..
          </p>
